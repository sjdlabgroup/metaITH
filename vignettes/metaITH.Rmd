...
1. Go to https://github.com/Elise-Merritt/metaITH  
...
*The folder each example file is in is specified under header "Arguments". For example, to run the first function "z_score_calculations" using provided example dataset "RNA_matrix.txt" you would first set the working directory to metaITH/input_files/sig_analysis_inputs.
