...
* type: Specifies the type of analysis to be used. Default parameter is "all".   
Options are:  
    * "all": Calculates all scores in one go, including proliferation, hypoxia, EMT, apoptosis, anti-PD1 favor, and drug resistance.
    * "hypoxia": Calculates hypoxia score. See function "hypoxia_signature" for details.
    * "proliferation": Calculates proliferation score. See function "proliferation_signature" for details.
    * "apoptosis": Calculates apoptosis score. See function "apoptosis_signature" for details
    * "drug-resistance": Calculates drug-resistance score. See function "drug_resistance_signature" for details.
    * "emt": Calculates emt score. See function "emt_signature" for details.
    * "anti-PD1": Calculates anti-PD1 favor score. See function "anti_PD1_favor_signature" for details
